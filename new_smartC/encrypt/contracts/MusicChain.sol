...
contract MusicChain {
    ...
    mapping (address => mapping(bytes32 => bytes32)) public links;  //Media Hash and the link uploaded by creator
    ...
    function sendLink(address recipient,bytes32 media_id, bytes32 link) public{
